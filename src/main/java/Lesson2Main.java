public class Lesson2Main {
    ...
    lesson2Main.checkScore("John Doe", 1,40, isBonusAvailable);
    lesson2Main.checkScore("Mark Smith", 2, 50, isBonusAvailable);
    lesson2Main.checkScore("Anna Smith", 3, 60, isBonusAvailable);
